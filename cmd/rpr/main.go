...
func showHelp() {
	...
	fmt.Println("  interval       Execute command at regular intervals")
	fmt.Println("  count          Execute command a specific number of times")
	fmt.Println("  duration       Execute command for a specific duration")
	fmt.Println()
